...
The bundled `relays` PI WEB plugin ships the same skill to PI WEB sessions:
`pi-web-plugins/relays/skills/relay/SKILL.md` is a symlink to the canonical file
