...
const usage: BackgroundSessionUsage = { input: 2, output: 3, cacheRead: 1, cacheWrite: 0, total: 6, estimatedCostUsd: 0 };
...
describe("AutomationSessionRunner", () => {
  ...
  it("turns a failed terminal prompt status into a failed run and keeps unknown zero cost absent", async () => {
